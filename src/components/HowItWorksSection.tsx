...
const HowItWorksSection = () => {
  return (
    <section id="how-it-works" className="relative py-24 px-6 overflow-hidden">
      ...
      {/* Background glow */}
      <div className="absolute top-40 left-1/3 w-96 h-96 bg-notify-neon/10 rounded-full blur-3xl -z-10 animate-pulse-light"></div>
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16 appear-on-scroll">
          <div className="inline-flex items-center space-x-2 bg-black/40 backdrop-blur-sm px-4 py-2 rounded-full border border-notify-neon/30 mb-4 animate-bounce-in">
            <Sparkles className="h-4 w-4 text-notify-neon" />
            <span className="text-sm font-medium">Simple Process</span>
          </div>
          
          <h2 className="text-3xl sm:text-4xl font-bold mb-4">How <span className="neon-text animate-neon-pulse">Notify</span> Works</h2>
          <p className="text-white/70 max-w-2xl mx-auto">
            Getting started with Notify is quick and easy, so you can start receiving important alerts in minutes.
          </p>
        </div>
        
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 slider-on-scroll">
          <div className="relative slide-item">
            <div className="relative z-10">
              <div className="neo-glass-card p-6 h-full">
                <div className="h-12 w-12 rounded-full flex items-center justify-center text-2xl font-bold bg-gradient-to-r from-notify-neon to-notify-lime text-black mb-4">
                  1
                </div>
                ...
                <ul className="space-y-2 stagger-animation">
                  <li className="flex items-start space-x-2 animate-fade-in">
                    <Check className="h-5 w-5 text-notify-neon mt-0.5" />
            ...
            <div className="absolute top-1/2 -right-6 hidden lg:block">
              <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M20 0L40 20L20 40L0 20L20 0Z" fill="#9eff00" fillOpacity="0.2" />
              </svg>
            </div>
          </div>
