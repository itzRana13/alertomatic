  ...
  return (
    <nav 
      className={cn(
        ...
        isScrolled ? "backdrop-blur-lg bg-notify-darker/80 shadow-lg" : "bg-transparent"
      )}
    >
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        <div className="flex items-center">
          <Bell className="h-6 w-6 text-notify-purple mr-2" />
        ...
        <div className="hidden md:flex items-center space-x-8">
          ...
          <a href="#why-notify" className="text-sm font-medium text-white/80 hover:text-white transition-colors">Why Notify</a>
          <a href="#download" className="button-transition bg-gradient-to-r from-notify-purple to-notify-blue text-white px-5 py-2.5 rounded-lg hover:shadow-lg hover:-translate-y-0.5">
            Download
          </a>
        </div>
